...
public class Main {
	...
	public static void main(String [] args) {
		...
		//set the next village for each village. The village 0 is the next village of the cable car,
        //while the cable car is the next stop of the last village.
		for(int i=0; i<n-1; i++){
			village[i].setNextV(village[i+1]);
		}
		village[n-1].setNextV(cableCar);
		cableCar.setNextV(village[0]);
